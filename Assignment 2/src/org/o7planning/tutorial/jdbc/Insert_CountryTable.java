...
public class Insert_CountryTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Insert_CountryTable frame = new Insert_CountryTable();
	 ...
	 */
	public Insert_CountryTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblInsertInCountryTable = new JLabel("Insert in Country table");
		lblInsertInCountryTable.setBounds(252, 11, 219, 45);
		lblInsertInCountryTable.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblInsertInCountryTable.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblInsertInCountryTable);
		...
		lblRegionId.setBounds(102, 222, 61, 14);
