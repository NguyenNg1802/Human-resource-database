...
public class Delete_JobTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_JobTable frame = new Delete_JobTable();
	 ...
	 */
	public Delete_JobTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblDeleteATuple = new JLabel("Delete a tuple in Job Table");
