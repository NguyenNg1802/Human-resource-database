...
public class Update_JobHistoryTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Update_JobHistoryTable frame = new Update_JobHistoryTable();
	 ...
	 */
	public Update_JobHistoryTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblUpdateInJobHistoryTable = new JLabel("Update in Job History table");
		lblUpdateInJobHistoryTable.setBounds(252, 11, 219, 45);
		lblUpdateInJobHistoryTable.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblUpdateInJobHistoryTable.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblUpdateInJobHistoryTable);
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
				      ...
				      pst.setDate(1,java.sql.Date.valueOf(textField_1.getText()));
				      pst.setDate(2,java.sql.Date.valueOf(textField_2.getText()));
