...
public class Insert_LocationTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Insert_LocationTable frame = new Insert_LocationTable();
	 ...
	 */
	public Insert_LocationTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblInsertInLocationTable = new JLabel("Insert in Location table");
		lblInsertInLocationTable.setBounds(252, 11, 219, 45);
		lblInsertInLocationTable.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblInsertInLocationTable.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblInsertInLocationTable);
		...
		JButton btnSave = new JButton("Data inserted");
