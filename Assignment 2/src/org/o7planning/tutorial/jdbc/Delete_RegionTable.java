...
public class Delete_RegionTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_RegionTable frame = new Delete_RegionTable();
	 ...
	 */
	public Delete_RegionTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblDeleteATuple = new JLabel("Delete a tuple in Region Table");
		...
		lblRegionID.setBounds(150, 181, 97, 20);
