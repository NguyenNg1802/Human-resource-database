...
public class Update_JobTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Update_JobTable frame = new Update_JobTable();
	 ...
	 */
	public Update_JobTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblUpdateInJobTable = new JLabel("Update in Job table");
		lblUpdateInJobTable.setBounds(252, 11, 219, 45);
		lblUpdateInJobTable.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblUpdateInJobTable.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblUpdateInJobTable);
