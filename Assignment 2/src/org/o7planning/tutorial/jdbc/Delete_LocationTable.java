...
public class Delete_LocationTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_LocationTable frame = new Delete_LocationTable();
	 ...
	 */
	public Delete_LocationTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblDeleteATuple = new JLabel("Delete a tuple in Location Table");
		...
		lblLocationID.setBounds(150, 181, 97, 20);
