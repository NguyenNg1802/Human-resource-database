...
public class Delete_DepartmentTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_DepartmentTable frame = new Delete_DepartmentTable();
	 ...
	 */
	public Delete_DepartmentTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblDeleteATuple = new JLabel("Delete a tuple in Department Table");
		...
		lblDepartmentID.setBounds(150, 181, 97, 20);
