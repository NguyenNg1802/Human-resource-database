...
public class Delete_CountryTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_CountryTable frame = new Delete_CountryTable();
	 ...
	 */
	public Delete_CountryTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblDeleteATuple = new JLabel("Delete a tuple in Country Table");
		...
		lblCountryID.setBounds(150, 181, 97, 20);
