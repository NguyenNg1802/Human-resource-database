...
public class Update_EmployeeTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Update_EmployeeTable frame = new Update_EmployeeTable();
	 ...
	 */
	public  Update_EmployeeTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblInsertInEmployee = new JLabel("Update in Employee table");
		lblInsertInEmployee.setBounds(239, 11, 226, 45);
		...
		btnSave.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
				      ...
				      pst.setDate(5, java.sql.Date.valueOf(textField_5.getText()));
				      ...
				      java.sql.Date d = java.sql.Date.valueOf(textField_5.getText()); // get day,month,year 
				      ...
				      if ( l.getDayOfMonth() == 0 ) {
				    	  JOptionPane.showMessageDialog(null, "Error! Date can't be NULL");
				      }
				      if ( l.getMonthValue() == 0 ) {
				    	  JOptionPane.showMessageDialog(null, "Error! Month can't be NULL");
				      }
				      if (  l.getYear() == 0) {
				    	  System.out.println("HAHAHAHA"+l.getYear());
				    	  JOptionPane.showMessageDialog(null, "Error! Year can't be NULL");
				      }
