...
public class Delete_EmployeeTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Delete_EmployeeTable frame = new Delete_EmployeeTable();
	 ...
	 */
	public Delete_EmployeeTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblDeleteATuple = new JLabel("Delete a tuple in Employee Table");
		...
		lblEmployeeId.setBounds(150, 181, 97, 20);
