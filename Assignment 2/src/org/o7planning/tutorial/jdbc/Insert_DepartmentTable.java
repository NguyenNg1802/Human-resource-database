...
public class Insert_DepartmentTable extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Insert_DepartmentTable frame = new Insert_DepartmentTable();
	 ...
	 */
	public Insert_DepartmentTable() throws ClassNotFoundException, SQLException {
		...
		JLabel lblInsertInDepartmentTable = new JLabel("Insert in Department table");
		lblInsertInDepartmentTable.setBounds(252, 11, 219, 45);
		lblInsertInDepartmentTable.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblInsertInDepartmentTable.setHorizontalAlignment(SwingConstants.CENTER);
		contentPane.add(lblInsertInDepartmentTable);
